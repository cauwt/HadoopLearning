 ...
 *
 */
public class MRDescScoreGroupByAge extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new MRDescScoreGroupByAge(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MRDescScoreGroupByAge.class);
